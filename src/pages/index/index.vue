<template>
  <view>
    ...
    <view class="cu-bar tabbar bg-white shadow foot">
      <view class="action" data-cur="home" @click="NavChange">
        <view :class="PageCur=='home'?'animation-scale-up':''" class='cuIcon-cu-image'>
      ...
      <view class="action" data-cur="my" @click="NavChange">
        <view :class="PageCur=='my'?'animation-scale-up':''" class='cuIcon-cu-image'>
...
export default {
  ...
  onShow: function () {
    this.indexInit() //onShow after onLoad
  },

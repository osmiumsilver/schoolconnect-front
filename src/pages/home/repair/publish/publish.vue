      ...
      <view slot="content">
		...
		<view class="main-form-list">
			<view class="apply-item">
				<text>申报人：</text>
				<input class="in-1" v-model="formData.name" ></input>
			</view>

			<view class="apply-item">
				<text>申报地点：</text>

				<input class="in-3" type="text" maxlength="6" v-model="formData.location"></input>
			</view>
			...
			<view class="apply-item apply-desc">
				...
				<textarea class="in-5" placeholder="请说明要维修的情况" placeholder-style="color:#ccc;font-size:14px;"
					type="string" maxlength="50" v-model="formData.description"></textarea>
			</view>
		</view>

		<view class="radio-list">
			<radio-group @change="changLevel" style="display: flex !important;">

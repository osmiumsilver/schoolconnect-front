    ...
    <view class="main-detail-list">
      <view class="content-view border-bottom">
        <view class="label-item">
          ...
          <text>{{ user.campaignLauncher }}</text>
        </view>
        <view class="label-item">
      ...
      <view class="footer-view">
        <view class="actions-item item-1" @click="callApplyPhone">
          <text>一键联系</text>
        </view>
        <view v-if="(!participate && user.status === 0)" class="actions-item item-2" @click="cancelApply">
          <text>报名参加</text>
        </view>
        <view v-if="(!participate && user.status === 0)" class="actions-item item-2" @click="cancelApply">
          <text>撤销报名</text>
        ...
        <view v-if="(!participate && user.status === 2)" class="actions-item item-4">
          <text style="color: #07c160;">活动已结束</text>
        </view>
      </view>
    </view>
  </view>

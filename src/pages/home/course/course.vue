...
<template>
  <view>
    ...
    <!-- 学期选择 -->
    <term-picker @year="xnmClick" @semester="xqmClick" @yearArray="coYearClick" pickerType="course"></term-picker>
...
export default {
  ...
  methods: {
    init: function () {
      ...
      let getData = {};
      getData['classNo'] = uni.getStorageSync('user_info').classNo;
      getData['year'] = this.year
          getData['semester']= this.semester
      this.$reqs(":8081/schedule/class", 'GET', getData, res => {
        if (res.code == 200) {
    ...
    getCourse: function () {
      ...
      this.$reqs(":8081/course", "GET", getData, res => {
        uni.setStorageSync('course_list', res.data.data)
